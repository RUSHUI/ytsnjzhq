/*!
 * @packet brooder.game.util.touch;
 */
    ...
    this.touch(function(e){
        if(e.action==="up"){
            if(!e.ismove&&e.timeLast>30){
                ...
                setTimeout(function(){
                    n.transition().set("opacity",function(){
                        this.remove();
                        fn&&fn.call(ths);
                    }).toggleClass("hover");
                },0);
...
$.fn.swipeLeft = function (fn) {
    this.touch(function (e) {
        if (e.action === "up") {
            ...
            if (e.timeLast < 200 && e.timeLast > 100  && e.direction === "left") {
                if (fn) {
                    fn.call(this);
                }
            }
