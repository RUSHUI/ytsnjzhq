/*!
 * @packet brooder.view.table;
 * @css brooder.style.table;
 */
Module({
    name: "tablebase",
    extend: ["view"]
...
Module({
    ...
    option: {
        ...
        num: true,
        singleselect: false,
        tool: ["refresh", "deletemulti", "add", "uploadfile"],
        deal: ["edit", "delete"],
    ...
    drawToolbar: function() {
        ...
        if (ops.tool.length > 0) {
            ...
            for (var i in ops.tool) {
                str += "<div class='tbtn toolbtn' toolnum='" + i + "' title='" + (ops.tool[i].title ? ops.tool[i].title : "") + "'>" +
    ...
    drawFootbar: function() {
        var str = "<div class='table-foot'>" +
                "<div class='btn-group'>" +
                "<div class='tbtn prev' title='上一页'><i class='fa fa-chevron-left'></i></div>" +
                "<div class='tbtn page page0'>1</div>" +
                "<div class='tbtn dot1 disabled'>...</div>" +
                "<div class='tbtn page page1'>2</div>" +
                "<div class='tbtn page page2'>3</div>" +
                "<div class='tbtn page page3'>4</div>" +
                "<div class='tbtn dot2 disabled'>...</div>" +
                "<div class='tbtn page page4'>5</div>" +
                "<div class='tbtn next' title='下一页'><i class='fa fa-chevron-right'></i></div>" +
                "</div>" +
        ...
        str += "</select>" +
                "<input type='text' style='min-width:60px;width:60px;margin-left:10px;'/>" +
                "<div class='tbtn gotopagex' title='跳转'><i class='fa fa-long-arrow-right'></i></div>" +
    ...
    drawRightBody: function() {
        ...
        if (this.tableData.rows.length === 0) {
            str += "<div style='line-height:30px;padding-left:30px;'>没有用于显示的数据</div>";
        }
        str += "</div>";
        return str;
    },
